...
background-image: url(police_login_page_bg.png);
...
<body>
 ...
 <div  align="center" >
	<div class="form" style="margin-top: 3%">
		<form method="post">
			<img src="police_login_logo.png" class="img-fluid rounded-circle" alt="police" style="width: 100px;">
			<p class="h1" style="color: #fff">Police Login</p>
